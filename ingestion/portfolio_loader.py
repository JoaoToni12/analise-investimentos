...
COLUMN_ALIASES: dict[str, list[str]] = {
    "ticker": ["ticker", "codigo", "ativo", "symbol", "code"],
    "asset_class": ["asset_class", "classe", "class", "tipo", "type"],
    "quantity": ["quantity", "quantidade", "qtd", "qty", "shares"],
    "avg_price": ["avg_price", "preco_medio", "pm", "average_price", "cost"],
    "target_weight_pct": ["target_weight_pct", "target", "peso_alvo", "target_weight", "alvo"],
}
